        ...
        <%@ include file="/WEB-INF/jsp/fragment/adminTask.jsp" %>
            <div class="midarea">
                ...
                <div class="admin-action">
                    Edit the book details and save:${message}
                        ...
                        <table style="margin-top:16px;">
                            <tr valign="top">
                                ...
                                <td class="insert-new-book-right">
                                    <input name="title" class="input-reg-book title-list" type="text" value="${book.title}"/>
                            ...
                            <tr valign="top">
                                ...
                                <td class="insert-new-book-right">
                                    ...
                                    <input name="call_number" class="input-reg-book call-number-list" type="text" value="${n}"/>
                                    </c:forEach>
                            ...
                            <tr valign="top">
                                ...
                                <td class="insert-new-book-right">
                                    <span id="book-authors-list">
                                        <c:forEach var="n" items="${book.author}" varStatus="a" >
                                        <input name="author" class="input-reg-book-shorter author-list" type="text" value="${n}"/>
                                        </c:forEach>
                                    </span>
                            ...
                            <tr valign="top">
                                ...
                                <td class="insert-new-book-right">
                                    <input name="imprint" class="input-reg-book imprint-list" type="text" value="${book.imprint}" />
                            ...
                            <tr valign="top">
                                ...
                                <td class="insert-new-book-right">
                                    <input name="year" class="input-reg-book-shorter year-list" id="year-4-digit" type="text" value="${book.year}" />
                            ...
                            <tr valign="top">
                                ...
                                <td class="insert-new-book-right">
                                    <input name="publisher" class="input-reg-book publisher-list" type="text" value="${book.publisher}" />
                            ...
                            <tr valign="top">
                                ...
                                <td class="insert-new-book-right">
                                    <span id="book-isbn-list">
                                        <c:forEach var="n" items="${book.isbn}" varStatus="a" >
                                        <input name="ISBN" class="input-reg-book-shorter isbn-list" type="text" value="${n}"/>
                                        </c:forEach>
                                    </span>
                            ...
                            <tr valign="top">
                                ...
                                <td class="insert-new-book-right">
                                    <textarea name="desc" class="input-reg-book">${book.description}</textarea>
                                </td>
                            </tr>
                            <tr valign="top">
                                <td  class="insert-new-book-left">Subject*:</td>
                                <td class="insert-new-book-right">
                                    <span id="book-subject-list">
                                        <c:forEach var="n" items="${book.subject}" varStatus="a" >
                                        <input name="subject" class="input-reg-book-shorter subject-list" type="text" value="${n}" />
                                        </c:forEach>
                                    </span>
                            ...
                            <tr valid="top" style="display:none;">
                                ...
                                <td class="insert-new-book-right">
                                    <input type="file" class="input-reg-book" size="25" name="image" />
                            ...
                            <tr>
                                <td colspan="2" align="left" style="padding-top:12px;">
                                    ...
                                    <input id="register-book" type="button" value="Save" style="width:120px;"/>
